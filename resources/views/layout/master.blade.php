	...
	<div class="wrapper">
		<nav class="main-header navbar navbar-expand navbar-white navbar-light">
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="{{url('contact')}}" class="nav-link"><i class="fas fa-user"></i> Contact</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
					<a href="{{url('skview')}}" class="nav-link"><i class="fas fa-archive"></i> Surat Keputusan</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
					<a href="{{url('pembiayaanview')}}" class="nav-link"><i class="fas fa-archive"></i> Pembiayaan</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4" style="color: white;">
			<a href="{{url('dashboard')}}" class="brand-text">
				<span class="brand-text font-weight-light"
					style="text-align: center; margin-left: 50px; font-size: 24px; color: white;">
