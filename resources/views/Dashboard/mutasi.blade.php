					...
					<form id="mutasiform" method="POST">
						...
						<div class="form-row">
							<div class="form-group col-sm-4">
								...
								<input required name="tanggal_mutasi" id="tanggal_mutasi" type="date" class="form-control form-control-sm">
							</input>
						</div>
						<div class="form-group col-sm-4">
							<label>Status</label>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="table-responsive-sm">
					<table class="table table-sm table-hover" width="100%" id="datatable-karyawan" style="font-size: 15px;">
						<thead>
							<tr align="center">
								<th>NIK</th>
								<th>Nama Lengkap</th>
