                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            ...
                            @else
                                <img src="{{ asset('images/avatars/' . $karyawan->user->avatar) }}"
                                    class="img-circle img-fluid" style="width:150px; height: 150px;" alt="profile picture">
                            @endif
                        </div>
                        <h3 class="profile-username text-center fw-bold" style="font-size: 20px;">
                            {{ $karyawan->nama_lengkap }}
                        </h3>
                        <p class="text-muted text-center">{{ $karyawan->jabatan->jabatan }}</p>
                        <ul class="list-group list-group-unbordered mb-3">
                            <li class="list-group-item">
                                <a class="fw-bold">Jenis Kelamin</a>
                                <span class="float-right">{{ $karyawan->jk }}</span>
                            </li>
                            <li class="list-group-item">
                                <a class="fw-bold">Agama</a>
                                <span class="float-right text-end text-sm">{{ $karyawan->agama }}</span>
                            </li>
                            <li class="list-group-item">
                                <a class="fw-bold">Alamat</a>
                                <span class="float-right text-end text-sm"
                                    style="text-align: justify;">{{ $karyawan->alamat }}</span>
                            </li>
                            <li class="list-group-item">
                                <a class="fw-bold">No Telepon</a>
                                <span class="float-right text-end text-sm">{{ $karyawan->no_telepon }}</span>
                            </li>
                            <li class="list-group-item">
                                <a class="fw-bold">Email</a>
                                <span class="float-right text-end text-sm">{{ $karyawan->user->email }}</span>
                            </li>
                            <li class="list-group-item">
                                <a class="fw-bold">Visi</a>
                                <span class="float-right text-end text-sm">{{ $karyawan->visi }}</span>
                            </li>
                            <li class="list-group-item">
                                <a class="fw-bold">Misi</a>
                                <span class="float-right text-end text-sm">{{ $karyawan->misi }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
