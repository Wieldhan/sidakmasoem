                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-6">
                            ...
                            <input required name="nik" onkeypress="hanyaangka(event)" type="text"
                                class="form-control form-control-sm" value="{{ Auth::user()->karyawan->nik }}">
                        </div>
                        <div class="form-group col-sm-6">
                            <label>No KTP</label>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <select required name="jk" class="form-control form-control-sm" id="formcontroljk">
                                <option value="Laki Laki"
                                    {{ Auth::user()->karyawan->jk === 'Laki Laki' ? 'selected' : '' }}>Laki Laki
                                </option>
                                <option value="Perempuan"
                                    {{ Auth::user()->karyawan->jk === 'Perempuan' ? 'selected' : '' }}>Perempuan
                                </option>
                            </select>
                        </div>
                    </div>
