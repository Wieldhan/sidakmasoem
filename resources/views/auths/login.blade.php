    ...
    <div class="col-lg-4 mx-auto login-box" style="width: 650px; align-content: center;">
        <div class="login-logo">
            <img class="img-fluid" style="width:350px; height: auto;"
                src="{{ asset('images/sidak-login-logo.png') }}">
        </div>
                    ...
                    <form action="/simpandaftar" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group {{ $errors->has('agama') ? ' has-error' : '' }} col-sm-6">
                                <label>Agama</label>
                                <select required name="agama" class="form-control form-control-sm"
                                    id="formcontrolagama">
                                    <option>--Pilih Salah Satu--</option>
                                    <option>Islam</option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group {{ $errors->has('no_telepon') ? ' has-error' : '' }} col-sm-6">
                                ...
                                <input maxlength="15" required name="no_telepon" onkeypress="hanyaangka(event)"
                        ...
                        <div class="form-row">
                            <div class="form-group {{ $errors->has('alamat') ? ' has-error' : '' }} col-sm-4">
                                ...
                                <textarea style="height: 75px;" required name="alamat" id="alamat"
